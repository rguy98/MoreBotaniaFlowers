package com.brutalminecraft.morebotaniaflowers;

import com.brutalminecraft.morebotaniaflowers.botania.*;
...
@Mod("morebotaniaflowers")
public class MoreBotaniaFlowers
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    public MoreBotaniaFlowers() {
    ...
    private static void registerRenderTypes() {
        Registry.BLOCK.stream().filter(b -> Registry.BLOCK.getKey(b).getNamespace().equals(LibMisc.MOD_ID))
                .forEach(b -> {
                    if (b instanceof BlockFloatingFlowerExtended || b instanceof FlowerBlock
                            || b instanceof TallFlowerBlock || b instanceof BlockModMushroomExtended) {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("morebotaniaflowers", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
