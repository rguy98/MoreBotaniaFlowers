...
public class BlockFloatingFlowerExtended  extends BlockModWaterloggable implements ITileEntityProvider {
    private static final VoxelShape SHAPE = makeCuboidShape(1.6, 1.6, 1.6, 14.4, 14.4, 14.4);
    public final ExtendedDyeColors color;

    public BlockFloatingFlowerExtended(ExtendedDyeColors color, Properties props) {
        super(props);
        this.color = color;
    }
    ...
    public TileEntity createNewTileEntity(@Nonnull IBlockReader world) {
        return new TileFloatingFlowerExtended();
    }
}