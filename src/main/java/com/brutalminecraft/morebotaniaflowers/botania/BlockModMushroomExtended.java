...
public class BlockModMushroomExtended extends MushroomBlock implements IHornHarvestable, ICustomApothecaryColor {
    private static final VoxelShape SHAPE = makeCuboidShape(4.8, 0, 4.8, 12.8, 16, 12.8);
    public final ExtendedDyeColors color;

    public BlockModMushroomExtended(ExtendedDyeColors color, Properties builder) {
        super(builder);
        this.color = color;
    }
